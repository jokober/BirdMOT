...
def test_yolov8_train_from_nested_coco(local_data_path_fixture, slice_params_fixture, yolov8_params_fixture):
    dataset_path, train_coco_path, val_coco_path = create_sliced_dataset(train_coco_fixture_path, val_coco_fixture_path,
...
def test_sliced_yolov8_prediction(sahi_prediction_params, local_data_path_fixture):
    ...
    prediction_res = sliced_batch_predict(image_dir=coco_images_fixture_path, sahi_prediction_params=sahi_prediction_params)
